...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProcessingService = __webpack_require__(1);

	var _ProcessingService2 = _interopRequireDefault(_ProcessingService);
	...
	(function () {
	    ...
	    var URL = _UrlConstants2.default.URL;
	    ...
	    fetch(myRequest).then(function (response) {
	        ...
	        _ProcessingService2.default.processArticles(response.articles);
	...
	module.exports = {
	    processArticles: function processArticles(articles) {
	        ...
	        articles.map(function (article) {
	            var articleItem = new _Article2.default(article);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DomNode2 = __webpack_require__(3);

	var _DomNode3 = _interopRequireDefault(_DomNode2);
	...
	var _NodeBuilder = __webpack_require__(7);

	var _NodeBuilder2 = _interopRequireDefault(_NodeBuilder);

	var _BorderDecorator = __webpack_require__(8);

	var _BorderDecorator2 = _interopRequireDefault(_BorderDecorator);
	...
	var Article = function (_DomNode) {
	    _inherits(Article, _DomNode);
	    ...
	    function Article(fieldsObj) {
	        ...
	        _this.author = fieldsObj.author;
	        _this.description = fieldsObj.description;
	        _this.publishedAt = fieldsObj.publishedAt;
	        _this.title = fieldsObj.title;
	        _this.url = fieldsObj.url;
	        _this.urlToImage = fieldsObj.urlToImage;
	        return _this;
	    }
	    ...
	    _createClass(Article, [{
	        ...
	        value: function createArticleNode(article) {
	            ...
	            if (article.urlToImage) {
	                var image = new _NodeBuilder2.default('img');
	            ...
	            if (article.url && article.title) {
	                var title = new _NodeBuilder2.default('h3');
	                title.setClassName('article-node-title');
	                title.setInnerHTML(article.title);

	                var link = new _NodeBuilder2.default('a');
	                link.setClassName('article-node-link');
	                link.setHref(article.url);
	                link.getNode().appendChild(title.getNode());
	                link = new _BorderDecorator2.default(link);

	                articleNode.appendChild(link.getNode());
	            } else if (article.title) {
	                var _title = new _NodeBuilder2.default('h3');
	                _title.setClassName('article-node-title');
	                _title.setInnerHTML(article.title);
	                _title = new _BorderDecorator2.default(_title);

	                articleNode.appendChild(_title.getNode());
	            }

	            if (article.description) {
	                var description = new _NodeBuilder2.default('p');
	            ...
	            if (article.author) {
	                var author = new _NodeBuilder2.default('p');
	            ...
	            if (article.publishedAt) {
	                var publishedAt = new _NodeBuilder2.default('p');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Image = function (_DomNode) {
	    _inherits(Image, _DomNode);
	    ...
	    function Image(src, className) {
	        ...
	        _this.imageNode = document.createElement('img');
	        _this.imageNode.className = className;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Link = function (_DomNode) {
	    _inherits(Link, _DomNode);
	    ...
	    function Link(href, text, className) {
	        ...
	        _this.linkNode.className = className;
	        _this.linkNode.href = href;
	        _this.linkNode.innerHTML = text;
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Text = function (_DomNode) {
	    _inherits(Text, _DomNode);

	    function Text(type, text, className) {
	        _classCallCheck(this, Text);

	        var _this = _possibleConstructorReturn(this, (Text.__proto__ || Object.getPrototypeOf(Text)).call(this));

	        _this.textNode = document.createElement(type);
	        _this.textNode.className = className;
	        _this.textNode.innerHTML = text;
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Decorator2 = __webpack_require__(9);
	...
	var BorderDecorator = function (_Decorator) {
	    _inherits(BorderDecorator, _Decorator);

	    function BorderDecorator(visualComponent) {
	        _classCallCheck(this, BorderDecorator);

	        return _possibleConstructorReturn(this, (BorderDecorator.__proto__ || Object.getPrototypeOf(BorderDecorator)).call(this, visualComponent));
	    }

	    _createClass(BorderDecorator, [{
	        key: 'getNode',
	        value: function getNode() {
	            var decoratedNode = this.domNode.getNode();
		...
		exports.default = BorderDecorator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Decorator = function (_DomNode) {
	    _inherits(Decorator, _DomNode);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(16), 'Object', {defineProperties: __webpack_require__(57)});
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(30)(Function.call, __webpack_require__(61).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(20)(IteratorPrototype, __webpack_require__(35)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!(TO_PRIMITIVE in proto))__webpack_require__(20)(proto, TO_PRIMITIVE, __webpack_require__(168));
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (__webpack_require__(43) != Object || !__webpack_require__(178)(arrayJoin)), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY            = __webpack_require__(38)
	  ...
	  , task               = __webpack_require__(218).set
	...
	var USE_NATIVE = !!function(){
	  try {
	    ...
	    var promise     = $Promise.resolve(1)
	      , FakePromise = (promise.constructor = {})[__webpack_require__(35)('species')] = function(exec){ exec(empty, empty); };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(14)
	  , macrotask = __webpack_require__(218).set
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(223)('WeakSet', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(__webpack_require__(16)){
	  var LIBRARY             = __webpack_require__(38)
	    ...
	    , wks                 = __webpack_require__(35)
	    , createArrayMethod   = __webpack_require__(182)
	    , createArrayIncludes = __webpack_require__(46)
	    , speciesConstructor  = __webpack_require__(217)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(16) && $export($export.P + __webpack_require__(272), 'Object', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(38)|| !__webpack_require__(17)(function(){
	  var K = Math.random();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map     = __webpack_require__(221)
	  , $export = __webpack_require__(18)
	  , shared  = __webpack_require__(33)('metadata')
	  , store   = shared.store || (shared.store = new (__webpack_require__(225)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export     = __webpack_require__(18)
	  ...
	  , core        = __webpack_require__(19)
	  , microtask   = __webpack_require__(219)()
	  , OBSERVABLE  = __webpack_require__(35)('observable')
	  , aFunction   = __webpack_require__(31)
	  , anObject    = __webpack_require__(22)
	  , anInstance  = __webpack_require__(215)
	  , redefineAll = __webpack_require__(220)
